document.addEventListener('DOMContentLoaded', () => {
    ...
    const currentPlayerDisplay = document.getElementById('current-player'); // ADICIONADO
    const blackCapturedDisplay = document.getElementById('black-captured'); // ADICIONADO
    const redCapturedDisplay = document.getElementById('red-captured'); // ADICIONADO

    let currentPlayer = 'black';
    let selectedPiece = null;
    const pieces = [];
    let blackCaptured = 0; // ADICIONADO
    let redCaptured = 0; // ADICIONADO
    ...
    function movePiece(piece, newRow, newCol) {
        ...
        if (capturedPiece) {
            ...
            updateCapturedCount(capturedPiece.color); // ADICIONADO
...
function updateCapturedCount(color) { // ADICIONADO
        if (color === 'black') {
            blackCaptured++;
